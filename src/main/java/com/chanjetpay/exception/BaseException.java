...
public class BaseException extends RuntimeException{
	...
	protected BaseException(String defineCode, String defineDesc) {
		super();
		this.defineCode = defineCode;
	...
	protected BaseException(String defineCode, String defineDesc, String message) {
		super();
		this.defineCode = defineCode;
		this.defineDesc = defineDesc;
